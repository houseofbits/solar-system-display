...
import MilkyWay from '../resources/img/milky_way.jpg'
...
class SpaceModel extends PlanetModel{
    constructor(engine, scene, canvas, size) {
        ...
        this.sphereInner2 = BABYLON.Mesh.CreateSphere(this.name+"SphereInner2", 46, size*0.7, this.scene, false, BABYLON.Mesh.BACKSIDE);
